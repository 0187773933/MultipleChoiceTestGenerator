...
def get_md_files_in_directory( base_directory ):
	ALLOWED_EXTENSIONS = [ ".md" ]
	FilesPosixInBaseDirectory = base_directory.glob( "**/*" )
...
if __name__ == "__main__":
	...
	md_files = get_md_files_in_directory( base_directory )
	total_md_files = len( md_files )
	for md_file_index , md_file in enumerate( md_files ):
		print( f"[ {md_file_index + 1} ] of {total_md_files}" )
		md_text = read_text( str( md_file ) )
		...
		write_text( md_file.parent.joinpath( f"{md_file.stem}.html" ) , html )